...
X_train1, X_test1, y_train1, y_test1 = train_test_split(X, Y, test_size = 0.5,shuffle=True,random_state=10)
...
X_train2, X_test2, y_train2, y_test2 = train_test_split(X, Y, test_size = 0.60,shuffle=True,random_state=10)
...
X_train3, X_test3, y_train3, y_test3 = train_test_split(X, Y, test_size = 0.70,shuffle=True,random_state=10)

poly_features3 = PolynomialFeatures(degree=5)
...
print('Mean Square Error', metrics.mean_squared_error(y_test1, prediction3))
